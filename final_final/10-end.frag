...
void main(void){
	...
	vec3 pct3 = mainrd(p1, 0.5,0.9,-0.45);
	vec3 pct4 = mainrd(p1, 0.75,1.3,0.35);
	vec3 pct5 = mainrd(p1, 0.5,0.35,0.05);

	vec3 pct6 = mainrd(p1, 0.5,0.5,0.8);
	vec3 pct7 = mainrd(p1, 0.15,-1.7,2.4);
	vec3 pct8 = mainrd(p1, 0.85,0.5,0.9);
	vec3 pct9 = mainrd(p1, 0.5,-0.15,0.95);
	vec3 pct10 = mainrd(p1, 0.5,0.05,0.35);
	...
	color += vec3(pct6.x+pct6.y+pct6.z, pct6.x+pct6.y+pct6.z, pct6.x+pct6.y+pct6.z);
	color += vec3(pct7.x+pct7.y+pct7.z, pct7.x+pct7.y+pct7.z, pct7.x+pct7.y+pct7.z);
	color += vec3(pct8.x+pct8.y+pct8.z, pct8.x+pct8.y+pct8.z, pct8.x+pct8.y+pct8.z);
	color += vec3(0.0, pct9.x+pct9.y+pct9.z, pct9.x+pct9.y+pct9.z);
	color += vec3(pct10.x+pct10.y+pct10.z, pct10.x+pct10.y+pct10.z, pct10.x+pct10.y+pct10.z);

	color.rg *= fract(color.gb);
